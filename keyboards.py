...
inline_vote_netherlands = InlineKeyboardButton('The Netherlands', callback_data='Netherlands')
...
inline_vote_czech = InlineKeyboardButton('Czech Republic', callback_data='Czech')
...
inline_vote_macedonia = InlineKeyboardButton('North Macedonia', callback_data='Macedonia')
